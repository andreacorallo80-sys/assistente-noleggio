 DATA = {
    "ARVAL": {
        "B2B (Aziende)": {
            "regole": {
                "oggetto": {"art": "1", "testo": "Noleggio veicoli nuovi + RCA + Manutenzione + Soccorso.", "ragionamento": "Il contratto copre il mezzo e i servizi base. Attenzione: AdBlue e liquidi sono esclusi (Art. 12)."},
                ...
                "sinistri": {"art": "6-7 e 11", "test: "RCA inclusa. Denuncia entro 48h. Obbligo CAI firmato.", "ragionamento": "Senza firma della controparte o verbale, Arval addebita il 100% del danno per colpa presunta (Art. 11)."},
        ...
        "B2C (Privati)": {
            "regole": {
                ...
                "foro": {"art": "66 bis", "testo": "Foro del Consumatore (residenza del cliente).", "ragionamento": "Con i privati non possiamo imporre Firenze. Dobbiamo andare noi nel loro tribunale."}
            }
        }
    },
    "ALPHABET": {
        "B2B (Aziende)": {
            "regole": {
                ...
                "documenti": {"art": "9.1", "testo": "Smarrimento libretto costa 100€ + IVA.", "ragionamento": "Oneri fissi amministrativi non stornabili."},
